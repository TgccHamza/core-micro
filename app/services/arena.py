...
from app.models import ArenaSession, Project, ArenaSessionPlayers, Arena
...
async def send_invite_email(db: Session, player: ArenaSessionPlayers, email: str, fullname: str, organisation_name,
    ...
    try:
        async with httpx.AsyncClient() as client:
            email_data = {
                "html_body": f"Hi {fullname}, Welcome to gaming tool platform you have been invited from {organisation_name} to play this game link: <a href=\"{game_link}\">{game_name}</a>",
                "is_html": True,
